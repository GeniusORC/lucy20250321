...
MODEL_CONFIGS = {
    ...
    'det': {
        ...
        'checkpoint': 'E:/gaitanalysis/rtmdet_m_8xb32-100e_coco-obj365-person-235e8209.pth',
        'cat_id': 0,           # 人体检测的类别ID
    ...
    'pose': {
        ...
        'checkpoint': 'E:/gaitanalysis/rtmw-x_simcc-cocktail14_pt-ucoco_270e-384x288-f840f204_20231122.pth',
        'kpt_thr': 0.5,         # 关键点检测阈值
